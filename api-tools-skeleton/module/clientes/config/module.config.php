...
return [
    ...
    'api-tools-content-validation' => [
        ...
        'clientes\\V1\\Rest\\Certificado\\Controller' => [
            'input_filter' => 'clientes\\V1\\Rest\\Certificado\\Validator',
        ],
        'clientes\\V1\\Rest\\Endereco\\Controller' => [
            'input_filter' => 'clientes\\V1\\Rest\\Endereco\\Validator',
        ],
    ],
    'input_filter_specs' => [
        ...
        'clientes\\V1\\Rest\\Certificado\\Validator' => [
            0 => [
                'required' => true,
                'validators' => [],
                'filters' => [],
            ...
            1 => [
                ...
                'field_type' => 'int',
                'error_message' => 'Falha ao localizar id',
            ],
            2 => [
                'required' => true,
                'validators' => [],
        ...
        'clientes\\V1\\Rest\\Endereco\\Validator' => [
            0 => [
                'required' => true,
                'validators' => [],
                'filters' => [],
            ...
            1 => [
                ...
                'description' => 'Cidade',
                'field_type' => 'string',
                'error_message' => 'Cidade não informada',
            ],
            2 => [
                'required' => true,
                'validators' => [],
                ...
                'description' => 'Estado',
                'field_type' => 'string',
                'error_message' => 'Falha ao inserir um estado',
            ],
            3 => [
                'required' => true,
                'validators' => [],
                'filters' => [],
                'name' => 'Endereço',
                'description' => 'Detalhamento do endereço',
                'error_message' => 'Informe o endereço',
            ],
        ],
    ],
    'api-tools-mvc-auth' => [
